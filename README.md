...
> Interactive API documentation (OpenAPI / Swagger UI) is auto-generated by [Dedoc Scramble](https://scramble.dedoc.co) and is available at **`http://localhost:8080/docs/api`** while the application is running.
